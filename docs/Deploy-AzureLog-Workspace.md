...
This script will prepare Azure Subscription and Log Analytics workspace. This will be required if you want to send WEF events to Azure Log for Monitor and further Automation
